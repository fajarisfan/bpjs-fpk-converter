...
- Flags any discrepancies before submission — preventing errors in the financial disbursement pipeline
...
```
bpjs-fpk-converter/
├── app.py              # Main Streamlit app — FPK PDF to CSV converter
├── audit.py            # Jaspel audit validator — cross-check CSV vs SIMRS data
├── requirements.txt
├── packages.txt
└── README.md
```
...
- 🔍 Built-in audit validator catches discrepancies before submission using official Jaspel formula
